...
permalink: /latest/learn/how-to-deploy-and-run-ballerina-programs/
redirect_from:
...
1. A [`main()`](/latest/learn/by-example/the-main-function.html) function that runs as a terminating process.

2. A [`service`](/latest/learn/by-example/hello-world-service.html), which is a hosted non-terminating process.
